...
main(void)
{
  printf("In this demo, you can learn how to shade 3D objects using textures.\n");
  ...
  GLuint texture = load_texture_from_file("d6_uvtemplate.bmp");
