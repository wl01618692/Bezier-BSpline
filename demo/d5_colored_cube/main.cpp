...
main(void)
{
  printf("In this demo, you can learn how to draw 3D objects with colors.\n");
  ...
  window = glfwCreateWindow(1024, 768, "ECS 175 Demo (press 'g' to display GUI)", NULL, NULL);
  if (window == NULL) {
    glfwTerminate();
  ...
  glm::mat4 MVP(1.086396,
                -0.993682,
                -0.687368,
                -0.685994, // x0, y0, z0, w0
                0.000000,
                2.070171,
                -0.515526,
                -0.514496, // x1, y1, z1, w1
                -1.448528,
                -0.745262,
                -0.515526,
                -0.514496, // x2, y2, z2, w2
                0.000000,
                0.000000,
                5.642426,
                5.830953); // x3, y3, z3, w3
